...
#include "ModelBased/SpectrumGridHelp.h"
...
{
    assert(m_GetNbColsFunction != NULL);
...
{
    assert(m_GetNbRowsFunction != NULL);
...
{
    assert(m_GetNbBandsFunction != NULL);
...
{
    assert(m_GetValueFunction != NULL);
...
{
    assert(m_GetValueLatLonFunction != NULL);
