...
{
    return ((CDHDatabaseBase&)CDailyDatabase()).GetVersion(filePath);
}
ERMsg CDailyDatabase::DeleteDatabase(const std::string&  outputFilePath, CCallback& callback)
{
    return ((CDHDatabaseBase&)CDailyDatabase()).DeleteDatabase(outputFilePath, callback);
}
ERMsg CDailyDatabase::RenameDatabase(const std::string& inputFilePath, const std::string& outputFilePath, CCallback& callback)
{
    return ((CDHDatabaseBase&)CDailyDatabase()).RenameDatabase(inputFilePath, outputFilePath, callback);
}
